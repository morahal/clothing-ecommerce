...
function AccountStackScreen() {
  return (
    <AccountStack.Navigator>
      <AccountStack.Screen name="FavoritesTab" component={FavoritesTab} options={{ headerShown: false }}/>
...
function AccountTabs() {
  return (
    <AccountTabNavigator.Navigator screenOptions={{
      tabBarHideOnKeyboard: true,
      tabBarStyle: { display: 'none' },
      headerShown: false,
    }}>

      <AccountTabNavigator.Screen name="Favorites" component={AccountStackScreen}/>
...
const AccountPage = () => {
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Purchases')} style={styles.tab}>
