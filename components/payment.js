    ...
    if (validateInputs()) {
      ...
      const purchase = async (userData) => {
        try {
          ...
          const response = await fetch(`${BASE_URL}/purchase/create/`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${accessToken}`, // Ensure accessToken is correctly retrieved and included
            },
